...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.page-header','data' => ['title' => 'Ringkasan Hari Ini','subtitle' => ''.e($tanggalHariIni->translatedFormat('l, d F Y')).'','label' => 'Dashboard Overview','icon' => 'fa-chart-line']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php endif; ?>
<?php $component->withAttributes(['title' => 'Ringkasan Hari Ini','subtitle' => ''.e($tanggalHariIni->translatedFormat('l, d F Y')).'','label' => 'Dashboard Overview','icon' => 'fa-chart-line']); ?>
    ...
    ">
        ...
        <div>
            ...
            <p class="text-2xl font-bold text-[#0A2540] dark:text-white mt-2">
                Rp <?php echo e(number_format($ringkasan->total_pendapatan ?? 0, 0, ',', '.')); ?>
...
<div class="grid grid-cols-1 lg:grid-cols-2 gap-8 mb-10">
    ...
    ">
        ...
        ">
            ...
            ">
                Menampilkan
                <?php echo e($produkStokRendah->firstItem()); ?>

                -
                <?php echo e($produkStokRendah->lastItem()); ?>
            ...
            <div>
                <?php echo e($produkStokRendah->links('pagination::tailwind')); ?>
            ...
            ">
                ...
                <tr>
                    ...
                    <td class="
                        ...
                        text-emerald-600
                    ">
                        <?php echo e($produk->total_terjual ?? 0); ?>
