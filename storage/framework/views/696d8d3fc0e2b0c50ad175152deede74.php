            ...
            <div
                ...
                <div class="flex items-center justify-between px-4 sm:px-5 py-3 sm:py-4 border-b dark:border-slate-700">
                    ...
                    <span class="text-xs text-slate-500">
                        <?php echo e($totalNotif); ?> Notifikasi
                    </span>
                ...
                <div class="max-h-80 overflow-y-auto">
                    ...
                    <?php $__empty_1 = true; $__currentLoopData = $stokRendah; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $produk): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                    ...
                    <?php $__currentLoopData = $stokHabis; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $produk): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        ...
                        <a href="<?php echo e(route('penjualan.index')); ?>"
                            ...
                            <div class="flex-1 min-w-0">
                                ...
                                <div class="text-sm text-slate-600 dark:text-slate-300">
                                    Ada <?php echo e($transaksiOpen); ?> transaksi belum selesai
                                </div>
...
</script><?php /**PATH C:\laragon\www\pos\resources\views/layouts/topbar.blade.php ENDPATH**/ ?>